...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "Front Left";
    public static String leftRearMotorName = "Back Left";
    public static String rightFrontMotorName = "Front Right";
    public static String rightRearMotorName = "Back Right";
    ...
    private static double xMovement = 54.8677; //81.34056;
    private static double yMovement = 38.0781; //65.43028;
    ...
    public static double mass = 16.60148; //10.65942;
    ...
    public static double forwardZeroPowerAcceleration = -32.3427; //-34.62719;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -67.989; //-78.15554;
